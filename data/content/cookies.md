...
- **First-Party Cookies:** Set by {{COMPANY_NAME}} directly on our domain
...
- **Retargeting:** Displaying ads for {{APP_NAME}} when you visit other websites or apps
...
{{ADVERTISING_PLATFORMS:list}}
{{OTHER_AD_PLATFORMS:list}}
...
{{ADDITIONAL_THIRD_PARTY_LINKS:list}}
...
2. Enhanced Tracking Protection (Standard, Strict, or Custom)
3. Manage cookie permissions and data
...
3. **Delete Advertising ID:**
   - Settings → Google → Ads
   - Tap "Delete advertising ID" (Android 12+)

### 5.4 In-App Privacy Settings

Within the {{APP_NAME}} app:

1. Go to **Settings** or **Account Settings**
2. Navigate to **Privacy** or **Privacy Preferences**
3. Manage tracking and analytics preferences
4. Control personalized advertising settings
...
- Your consent choices are stored in a cookie for {{COOKIE_RETENTION_PERIOD}}
...
We maintain an inventory of all cookies and tracking technologies used on our App. You can request a detailed cookie inventory by contacting us at {{CONTACT_EMAIL}}.
...
Our App is not directed to children under the age of {{MINIMUM_AGE}}, and we do not knowingly collect personal information from children through cookies or other tracking technologies. If you believe a child under {{MINIMUM_AGE}} has provided us with personal information, please contact us at {{CONTACT_EMAIL}}.
...
**By continuing to use {{APP_NAME}}, you acknowledge that you have read and understood this Cookie Policy and agree to our use of cookies and similar technologies as described herein, subject to your consent choices and opt-out preferences.**
