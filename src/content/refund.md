...
**Last Updated:** __LAST_UPDATED_DATE__
...
__APP_NAME__ is distributed through third-party mobile app stores:
- **Apple App Store** (for iOS devices: iPhone, iPad, iPod Touch)
- **Google Play Store** (for Android devices)

All financial transactions, including purchases, subscriptions, in-app purchases, and refunds, are processed and managed by these app store platforms, not directly by __COMPANY_NAME__.

### 1.2 Dual Policy Structure
Refunds are subject to:
1. **App Store Policies:** Apple's and Google's respective refund policies
2. **Our Policy:** __APP_NAME__'s refund eligibility criteria as outlined below
...
- **Primary Authority:** Apple and Google have final authority over refund approvals processed through their platforms
- **Our Assistance:** We can assist with refund requests and advocate on your behalf, but cannot guarantee approval
- **Direct Refunds:** In limited circumstances, we may issue direct refunds for purchases made outside of app stores

### 1.4 Currency and Payment Methods
- All prices are displayed in __CURRENCY__ unless otherwise indicated
...
**Overview:**
Google LLC processes all payments for Android users. Google Play's refund policy applies to all purchases made through the Google Play Store.

**How to Request a Refund from Google:**

**Method 1: Google Play Website (Recommended)**
1. Visit: https://play.google.com/store/account/orderhistory
2. Sign in with your Google Account
3. Find the purchase you want to refund
4. Click "Request a refund" or "Report a problem"
5. Select the reason for your refund
...
**Method 3: Contact Developer (After 48 Hours)**
- If more than 48 hours have passed, Google may direct you to contact us directly
- Use the contact information in Section 5 below

**Google's Refund Policy:**

**One-Time Purchases (Apps, Games, In-App Items):**
...
- **After 48 Hours:** Contact the developer (__APP_NAME__)

**Subscriptions:**
- **Within 48 Hours:** Refund requests reviewed by Google
- **After 48 Hours:** Contact the developer; no automatic refunds for unused subscription time

**General Guidelines:**
- Google evaluates each refund request individually
- Repeated refund requests may be denied
- Abuse of refund system may result in account suspension
- Subject to Google Play Terms of Service: https://play.google.com/intl/en_us/about/play-terms/

**Processing Time:**
- Instant: Refunds within 2 hours are typically instant
- Standard: 3-5 business days for refund requests within 48 hours
- Extended: 5-10 business days for refunds processed after 48 hours
- Your financial institution may take additional time to process the credit
...
## 3. __APP_NAME__ Refund Eligibility Criteria

While app store policies govern the refund process, __COMPANY_NAME__ has established clear guidelines for when refunds are appropriate. We are committed to customer satisfaction and will work with you to resolve any legitimate issues.
...
- **Resolution Efforts:** You contacted our support team, and we were unable to resolve the issue within a reasonable timeframe (__REFUND_REVIEW_DAYS__ business days)
...
- **Subscription Billing Errors:** Charged after canceling a subscription with sufficient notice
...
- **Simple Regret:** You no longer want the App, subscription, or purchased items after using them
...
**User Responsibility:**
- **Failure to Use:** You purchased the App or subscription but didn't use it
...
- **Ignored Free Trial:** You didn't utilize available free trials before purchasing
- **User Error:** Problems caused by user error, misuse, or failure to follow instructions

**Subscription Management:**
- **Forgotten Cancellation:** Automatic subscription renewals when you forgot to cancel before the renewal date
- **Pro-Rated Refunds:** We do not provide partial refunds for unused time in a subscription billing period
- **Post-Cancellation Access:** You retain access through the end of your paid subscription period after canceling
- **Subscription Features:** You used subscription features and then request a refund for that period
...
- **Optimal Window:** Within __REFUND_WINDOW_DAYS__ days of purchase date
- **Extended Consideration:** Requests beyond __REFUND_WINDOW_DAYS__ days may be considered for technical issues documented within the timeframe
- **Maximum Window:** App store policies limit refunds to 90 days (Apple) or as specified by Google

**Subscriptions:**
- **Initial Subscription:** Within __SUBSCRIPTION_REFUND_WINDOW_DAYS__ days of initial subscription charge
- **Renewal Charges:** Within __SUBSCRIPTION_REFUND_WINDOW_DAYS__ days of each renewal charge
- **Free Trial Conversions:** Within __SUBSCRIPTION_REFUND_WINDOW_DAYS__ days after free trial ends and paid subscription begins
...
You have full control over your subscription and can cancel it at any time before the next renewal. Subscriptions are managed through your app store account.

**iOS / iPadOS (Apple App Store):**
1. Open the **Settings** app on your device
2. Tap your **Name** at the top
3. Tap **Subscriptions**
4. Select **__APP_NAME__** from your list of subscriptions
5. Tap **Cancel Subscription** (or **Cancel Free Trial** if in trial period)
6. Confirm the cancellation

**Alternative Method (iOS):**
1. Open the **App Store** app
2. Tap your **Profile Icon** in the top right
3. Tap **Subscriptions**
4. Select **__APP_NAME__**
...
**Alternative Method (Android Web):**
...
- Cancellation is processed immediately upon confirmation
- You retain full access to premium features until the end of your current billing period
- No charges will occur after your current billing period ends
- Your subscription will not automatically renew

**What Happens After Cancellation:**
- **During Current Period:** Full access to all premium features continues
- **After Period Ends:** Premium features become unavailable; you revert to free tier (if available)
- **Data Retention:** Your account and data remain intact; you can resubscribe at any time
- **No Partial Refunds:** Cancellation does not entitle you to a refund for the current billing period

**Reactivating a Canceled Subscription:**
- You can resubscribe at any time through the App
- Resubscription may be at the current pricing (not your original price)
- Previous purchase history and settings may be restored

### 4.3 Free Trials and Promotional Periods

**Free Trial Management:**
- **Trial Duration:** As specified at sign-up (typically 7, 14, or 30 days)
- **Cancellation Deadline:** Cancel at least __TRIAL_CANCELLATION_PERIOD__ before the trial ends to avoid being charged
...
- **Trial Restrictions:** We reserve the right to limit or deny free trial access to prevent abuse

**Canceling During Free Trial:**
- You can cancel your free trial at any time during the trial period
- **Immediate Effect:** Canceling a free trial typically ends access immediately (no remaining trial days)
- **Exceptions:** Some trials may allow continued access until the trial end date
- **No Charges:** If canceled before the trial ends, you will not be charged

**Promotional Pricing:**
- **Limited Time Offers:** Special promotional prices may be offered for a limited time
- **Price Upon Renewal:** After the promotional period, your subscription will renew at the standard price
- **Notification:** We will notify you of the standard price before charging
- **Cancellation:** You can cancel before the promotional period ends to avoid being charged the standard price

### 4.4 Subscription Billing and Renewal

**Automatic Renewal:**
- Subscriptions automatically renew at the end of each billing period unless canceled
- You authorize us (or the app store) to charge your payment method for recurring billing
- Renewal occurs 24 hours before the current period ends

**Billing Periods:**
- **Monthly:** Renews every month on the same date
- **Quarterly:** Renews every 3 months
- **Annual:** Renews every year on the same date
- **Other:** As specified at the time of purchase

**Billing Notifications:**
- You will receive a receipt from Apple or Google after each charge
- We may send you a reminder email before renewal (but this is not guaranteed)
- It is your responsibility to track your subscription status and cancel if desired

**Price Changes:**
- Subscription prices may change from time to time
- For existing subscribers, we will provide advance notice (typically 30 days) before any price increase
- You have the option to cancel your subscription if you do not agree to the new price
...
- Update payment information through your Apple or Google account settings
- Failed payments may result in suspended access or subscription cancellation

### 4.5 Subscription Tiers and Features

**Multiple Tiers:**
- We may offer different subscription tiers (e.g., Basic, Premium, Pro) with varying features and prices
- You can upgrade or downgrade between tiers through your account settings

**Upgrading:**
- Upgrades typically take effect immediately
- You may be charged a prorated amount for the remainder of your billing period
- The new tier's price will apply at the next renewal

**Downgrading:**
- Downgrades typically take effect at the end of your current billing period
- You retain access to higher-tier features until the billing period ends
- The lower-tier price will apply at the next renewal
...
## 5. How to Request a Refund Directly from __APP_NAME__
...
4. **Check Help Center:** Visit our help center at __SUPPORT_URL__ for troubleshooting guides
...
- **Purchase Receipt:** Order ID, transaction ID, or receipt from Apple/Google
...
**Email (Preferred):**
- Send an email to: __CONTACT_EMAIL__
...
2. **Review Period:** Our team will review your request within __REFUND_REVIEW_DAYS__ business days
...
**App Store Refunds (Apple/Google):**
...
- Processing time: __APP_STORE_PROCESSING_DAYS__ business days from app store approval
...
- Processing time: __DIRECT_REFUND_PROCESSING_DAYS__ business days from our approval

**Refund Methods by Payment Type:**
- **Credit/Debit Card:** Refund appears within __CARD_REFUND_DAYS__ business days
...
2. **Request a Review:** Ask for your case to be reviewed by a supervisor (email: __DISPUTE_EMAIL__)
...
## 6. Promotional Credits, Virtual Items, and In-App Currency

### 6.1 Virtual Items and In-App Currency

**General Policy:**
- Virtual items, in-app currency, credits, coins, gems, or other virtual goods are **generally non-refundable**
- These items have no real-world value and cannot be exchanged for cash

**Exceptions:**
- **Technical Errors:** You purchased virtual items but didn't receive them due to a technical error
- **Unauthorized Purchases:** Your account was compromised and unauthorized purchases were made
- **Billing Errors:** You were charged for virtual items you didn't intend to purchase
- **Critical Bugs:** Virtual items don't work as described due to App malfunction

**To Request a Refund for Virtual Items:**
- Follow the process in Section 5
- Provide evidence that an exception applies
- Include transaction details and screenshots

### 6.2 Promotional Offers and Discount Codes

**Promotional Codes:**
- Promo codes, discount codes, and coupons are **non-refundable** and **non-transferable**
- Cannot be exchanged for cash or credit
- Must be used within the specified validity period
- Subject to specific terms and conditions stated at the time of offer

**Promotional Pricing:**
- Special offers and limited-time discounts are not eligible for refunds if you later find a better price
- Prices are subject to change without notice
- We do not offer price adjustments or retroactive discounts

**Promotional Bundles:**
- Bundle purchases are treated as a single transaction
- Partial refunds for individual items within a bundle are not available
- Refund policies apply to the bundle as a whole

### 6.3 Gift Purchases and Gift Cards

**Gift Subscriptions:**
- Gifts purchased for others are subject to this refund policy
- The purchaser must request the refund (not the recipient)
- Unused gifts may be eligible for refunds

**Gift Cards:**
- Gift cards, gift codes, and prepaid balances are generally non-refundable
- Check with Apple or Google for their gift card refund policies

## 7. Regional Consumer Protection Laws and Rights
...
- Contact us at __CONTACT_EMAIL__
...
- Automatic Renewal Law (AB 2863): We must clearly disclose subscription terms and renewal conditions
- You can cancel subscriptions through a simple mechanism
...
- **Google (after 48 hours):** __APP_STORE_PROCESSING_DAYS__ business days
- **Total Time:** Typically __APP_STORE_PROCESSING_DAYS__ business days from request

**Direct Refunds from __APP_NAME__:**
- **Review:** __REFUND_REVIEW_DAYS__ business days to review your request
- **Processing:** __DIRECT_REFUND_PROCESSING_DAYS__ business days after approval
- **Total Time:** Up to __REFUND_PROCESSING_DAYS__ business days from request
...
**Credit/Debit Cards:**
- Refund appears within __CARD_REFUND_DAYS__ business days
- Statement will show credit from Apple, Google, or __COMPANY_NAME__
...
- If you paid through your mobile carrier, refunds appear as a credit on your carrier bill
- Processing time varies by carrier (typically 1-2 billing cycles)
- Contact your carrier for specific information

**Store Credit (App Store/Google Play Balance):**
- Processed immediately or within 24 hours
- Credit appears in your app store account balance
- Can be used for future purchases in the respective app store

**Gift Cards:**
- Refunds for gift card purchases return to the gift card balance
- Check with Apple or Google for their gift card refund policies

**Alternate Payment Methods:**
- For other payment methods, refunds are processed according to the payment provider's schedule
- Contact the payment provider for expected timelines

### 8.3 Account Status After Refund

**Immediate Effects:**
- Premium features and subscription access are revoked immediately upon refund processing
- Downloaded content may be removed or become inaccessible
- In-app purchases and virtual items are removed from your account
- Your account remains active (but reverts to free tier if available)

**Data and Content:**
- User-generated content you created remains in your account (subject to our Privacy Policy)
- Account settings and preferences are preserved
- You can continue using free features (if available)
- You may resubscribe or repurchase at any time
...
- **Loss of Access:** You will lose access to all purchased content, features, and subscription benefits
...
- Contact us immediately at __DISPUTE_EMAIL__
...
- Multiple refund requests for the same product or subscription
...
## 11. Changes and Updates to This Refund Policy
...
- This is Version __POLICY_VERSION__ of our Refund Policy
...
- **Refund Review:** Within __REFUND_REVIEW_DAYS__ business days
...
**Business Hours:**
- Monday - Friday: 9:00 AM - 6:00 PM (__JURISDICTION__ time)
...
Thank you for being a valued user of __APP_NAME__! We are committed to providing you with an excellent experience and fair treatment. If you have any questions about this Refund Policy or need assistance with a purchase, please don't hesitate to contact us. We're here to help!
